...
class Checkout extends Component<CheckoutProps & WithCheckoutProps & WithLanguageProps, CheckoutState> {
    ...
    state: CheckoutState = {
        ...
        showAddressNotSelectedError: false,
    };
    ...
    updateShowAddressError: (value: boolean) => void = value => {
        this.setState({ showAddressNotSelectedError: value });
    };

    updateAddressSelected: (value: boolean) => void = value => {
        if (value) {
            this.setState({ addressNotSelected: value, showAddressNotSelectedError: false });
        } else {
        ...
        return (
            ...
            >
                <div className="layout-main">
                    ...
                    <div className="checkout-view-header-checkout" id="checkout-view-header-checkout" style={ { display: 'none'} } />
                </div>
    ...
    private renderCustomerStep(step: CheckoutStepStatus): ReactNode {
        ...
        return (
            ...
            // >
                    ...
                    { [`checkout-step--${step.type}`]: !!step.type }
                ) }
                    >
                    <LazyContainer>
                    <Customer
            ...
            >
                <LazyContainer>
                    <Shipping
                        ...
                        updateAddressSelected={ this.updateAddressSelected }
                        updateShowAddressError={ this.updateShowAddressError }
                    />
                </LazyContainer>
                </li>
            // </CheckoutStep>
    ...
    private renderBillingStep(step: CheckoutStepStatus): ReactNode {
        ...
        // console.log('Checkout ---------', sameAsShipping);
        ...
        return (
            ...
            >
                <LazyContainer>
                <div className="checkout-view-header-billing" style={ { display: 'none'} } />
                    <Billing
                        billingFromCb={ this.handelBillingSubmit }
                        isBillingSameAsShipping = { sameAsShipping }
                        isPending={ isPending }
                        navigateBackToCustomerAndShippingStep= { this.navigateBackToCustomerAndShippingStep }
                        navigateNextStep={ this.navigateToNextIncompleteStep }
                        onReady={ this.handleReady }
                        onUnhandledError={ this.handleUnhandledError }
                        updateSameasShipping = { this.updateSameasShipping }
                    />
                </LazyContainer>
                </li>
            // </CheckoutStep>
    ...
    private renderPaymentStep(step: CheckoutStepStatus): ReactNode {
        ...
        return (
            ...
            >
                <LazyContainer>
                <div className="checkout-view-header" style={ { display: 'none'} } />
                    <Payment
                        checkEmbeddedSupport={ this.checkEmbeddedSupport }
                        isEmbedded={ isEmbedded() }
    ...
    private navigateBackToCustomerAndShippingStep: () => void = () => {
        this.navigateToStep(CheckoutStepType.Customer);
        this.showShipping();
    };

    private navigateToNextIncompleteStep: (options?: { isDefault?: boolean }, isBillingSameAsShipping?: boolean, step?: string) => void = (options, isBillingSameAsShipping = false, step) => {
        if (step === 'billing') {
            this.setState({ sameAsShipping: isBillingSameAsShipping });
        }
    ...
    private showShipping: () => void = () => {
        this.setState({
            showPayment: false,
        });
    };

    private updateSameasShipping: (isBillingSameAsShipping: boolean) => void = isBillingSameAsShipping => {
        this.setState({
            sameAsShipping: isBillingSameAsShipping,
        });
    };
