...
class Customer extends Component<CustomerProps & WithCheckoutCustomerProps, CustomerState> {
            ...
            >
              <div className="form-legend-container">
                  <Legend testId="shipping-address-heading">
                      <TranslatedString
                          id={ 'customer.customer_email_text' }
                      />
                  </Legend>
              </div>
    ...
    private renderGuestForm(): ReactNode {
        ...
        const { formLoading, emailEntred } = this.state;
        ...
        return (
            <GuestForm
                ...
                isLoading={ isContinuingAsGuest || isInitializing || isExecutingPaymentMethodCheckout || formLoading }
    ...
    private handleChangeEmail: (email: string) => void = email => {
        this.draftEmail = email;
        this.setState({ emailEntred: email });
    };
