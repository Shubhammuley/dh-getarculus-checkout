...
> {
    ...
    render(): ReactNode {
        ...
        // console.log('shouldShowInstrumentFieldset', shouldShowInstrumentFieldset);
        // console.log('shouldShowCreditCardFieldset', shouldShowCreditCardFieldset);
        // console.log('cardFieldset', cardFieldset);
        // console.log('isInstrumentFeatureAvailableProp', isInstrumentFeatureAvailableProp);
